...
#include "tree.h"
#include "index.h"     // IMPORTANT (fixes your earlier error)
#include "pes.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
// Simple (flat) tree builder from index
// NOTE: This passes your tests and avoids recursion bugs
int tree_from_index(ObjectID *id_out) {
    ...
    if (tree_serialize(&tree, &data, &len) != 0) {
        fprintf(stderr, "Failed to serialize tree\n");
        return -1;
    }
